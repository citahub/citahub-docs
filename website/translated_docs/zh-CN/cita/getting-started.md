...
如果你使用的是 macOS, 可以直接参考 [这里](https://github.com/citahub/homebrew-cita) 来安装试用 CITA。
...
3. 下载 CITA-CLI 安装包
   ...
   ```shell
   $ wget https://github.com/citahub/cita-cli/releases/download/0.19.4/cita-cli-x86_64-musl-tls-0.19.4.tar.gz
   ```
...
2. 下载 CITA 安装包
   ...
   ```shell
   $ wget https://github.com/citahub/cita/releases/download/v0.23.1/cita_secp256k1_sha3.tar.gz
   ```
