...
- Parameters
  ...
  2. `Boolean` - 是否返回交易信息(True: 返回详细交易列表| False: 只返回交易 hash).

```js
params: ['0x296474ecb4c2c8c92b0ba7800a01530b70a6f2b6e76e5c2ed2f89356429ef329', true]
```
...
### 在 Account 中保存 ABI 和获取 ABI

默认将接收方地址为`0xffffffffffffffffffffffffffffffffff010001` 的交易为保存合约 ABI 交易类型。
