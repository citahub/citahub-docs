...
const Community = () => (
  <div className="docMainWrapper wrapper" className="post">
    <Container padding={['all']}>
      <article>
        ...
        <p>
          <translate>
            Our team can offer dedicated support technicians to assist you in developing with CITA stack.What can we do
            for you ?
          </translate>
        </p>
        ...
        <ul>
          ...
          <li>
            <translate>
              ...
              enterprise.No matter which of blockchain network you choose to build, we make sure to offer you the right
              set of features.
            </translate>
          </li>
        </ul>
        ...
        <p>
          <translate>
            talks.citahub.com Feel free to share articles and tutorials as well as start discussions about all kinds of
            hot topics about blockchain.
          </translate>
        </p>
