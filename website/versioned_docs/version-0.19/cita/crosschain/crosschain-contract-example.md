---
id: version-0.19-crosschain-contract-example
title: Crosschain Contract Examples
...
可以参照[示例合约](https://github.com/citahub/cita/blob/develop/scripts/contracts/src/native/CrossChain.sol)。
