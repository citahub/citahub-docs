...
const Community = () => (
  <Container className="docMainWrapper wrapper">
    <Container className="mainContainer versionsContainer">
      <div className="post">
        <article>
          <h1>
            <translate>CITA Community</translate>
          </h1>
          <p>
          ...
          <p>
            ...
            <translate>
              would be a perfect place to get help, no matter having a code-level questions or being stuck with a
              specific error.{' '}
            </translate>
          </p>
          ...
          <p>
            <translate>
              Our team can offer dedicated support technicians to assist you in developing with CITA stack. What can we
              do for you?
            </translate>
          </p>
          <ul>
            <li>
              <translate>
                Advisory services: Tap into our extensive experience(Coming soon) in blockchain architecture and ensure
            ...
            <li>
              <translate>
                ...
                enterprise. No matter which of blockchain network you choose to build, we make sure to offer you the
          ...
          <p>
            <translate>
              Please keep in mind nor is code the only way to contribute to the project, we strongly value documentation
          ...
          <ul>
            ...
            <li>
              <translate>
                Github issue and Github Project to create, organize and track logical issues, including bugs and
                improvement
              </translate>
            </li>
            <li>
          ...
          <p>
            <translate>
              That is, Github issue and CIP are used to describe what should be fixed or changed, and high - level
              approaches, and pull requests describe how to implement that change in the project 's source code.
            </translate>
          </p>
          ...
          <p>
            <translate>
              Feel free to share articles and tutorials as well as start discussions about all kinds of hot topics about
              blockchain.
            </translate>
          </p>
