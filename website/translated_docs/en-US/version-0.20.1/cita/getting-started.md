...
---
CITA is an open source blockchain kernel where anyone can build their own blockchain based on CITA, and in this document we'll take you to build a simple chain and run the nodes in it.
...
The system needs to support Docker installation.
